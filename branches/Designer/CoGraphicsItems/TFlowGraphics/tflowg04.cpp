#include "tflowg04.h"
#include"../FlowPropery/PropertyItems/g04property.h"


TFlowG04::TFlowG04(double StartX, double StartY, double StopX, double StopY,
                     const Qt::PenStyle &LineStyle, const int LineWidth,
                     const QColor &LineColor, const QColor &BackColor) :
    TFlowBase(StartX, StartY, StopX, StopY, LineStyle, LineWidth, LineColor, BackColor)
{
    SetType(CoItem::G04);
    PropertyBase = new G04Property();
    connectWithText();
}
...
CoItem *TFlowG04::Copy()
{
    TFlowG04 *Flow = new TFlowG04();
...
void TFlowG04::Copy(TFlowG04 *flow)
{
    if(NULL == flow)
    {
        return;
...
void TFlowG04::Draw(QPainter *painter)
{
