...
/***************************************************************************
**                                                                        **
**   TCustomPlot, an easy to use, modern plotting widget for Qt            **
...
**  Website/Contact: http://www. TCustomPlot.com/                          **
**             Date: 04.09.17                                             **
**          Version: 2.0.0                                                **
****************************************************************************/
...
/*!
  The QCP Namespace contains general enums, QFlags and functions used throughout the  TCustomPlot
  library.
...
/*!
  ...
  \see  TCustomPlot::savePng,  TCustomPlot::saveJpg,  TCustomPlot::saveBmp,  TCustomPlot::saveRastered
*/
...
/*!
  ...
  \see  TCustomPlot::setAntialiasedElements,  TCustomPlot::setNotAntialiasedElements
*/
...
/*!
  ...
  \see  TCustomPlot::setPlottingHints
*/
enum PlottingHint { phNone              = 0x000 ///< <tt>0x000</tt> No hints are set
                    ...
                    ,phImmediateRefresh = 0x002 ///< <tt>0x002</tt> causes an immediate repaint() instead of a soft update() when  TCustomPlot::replot() is called with parameter \ref  TCustomPlot::rpRefreshHint.
...
/*!
  Defines the mouse interactions possible with  TCustomPlot.

  \c Interactions is a flag of or-combined elements of this enum type.

  \see  TCustomPlot::setInteractions
*/
enum Interaction { iRangeDrag         = 0x001 ///< <tt>0x001</tt> Axis ranges are draggable (see \ref QCPAxisRect::setRangeDrag, \ref QCPAxisRect::setRangeDragAxes)
                   ...
                   ,iMultiSelect      = 0x004 ///< <tt>0x004</tt> The user can select multiple objects by holding the modifier set by \ref  TCustomPlot::setMultiSelectModifier while clicking
...
/*!
  ...
  \see  TCustomPlot::setSelectionRectMode,  TCustomPlot::selectionRect, QCPSelectionRect
*/
...
/*! \internal
  ...
  compiler flag \c  TCustomPlot_CHECK_DATA is set.
*/
...
class QCPLayer : public QObject
{
  ...
  Q_PROPERTY( TCustomPlot* parentPlot READ parentPlot)
...
public:
  ...
  */
  ...
  QCPLayer( TCustomPlot* parentPlot, const QString &layerName);
  virtual ~QCPLayer();

  // getters:
   TCustomPlot *parentPlot() const { return mParentPlot; }
...
class  QCPLayerable : public QObject
{
  ...
  /// \endcond
public:
  QCPLayerable( TCustomPlot *plot, QString targetLayer=QString(), QCPLayerable *parentLayerable=0);
...
protected:
  ...
  // introduced virtual methods:
  virtual void parentPlotInitialized( TCustomPlot *parentPlot);
  ...
  // non-property methods:
  void initializeParentPlot( TCustomPlot *parentPlot);
...
class  QCPSelectionRect : public QCPLayerable
{
  Q_OBJECT
public:
  explicit QCPSelectionRect( TCustomPlot *parentPlot);
...
class  QCPMarginGroup : public QObject
{
  Q_OBJECT
public:
  explicit QCPMarginGroup( TCustomPlot *parentPlot);
...
public:
  ...
  */
  ...
  explicit QCPLayoutElement( TCustomPlot *parentPlot=0);
...
protected:
  ...
  virtual void parentPlotInitialized( TCustomPlot *parentPlot) Q_DECL_OVERRIDE;
...
{
public:
  explicit QCPAxisPainterPrivate( TCustomPlot *parentPlot);
...
class  QCPItemAnchor
{
  Q_GADGET
public:
  QCPItemAnchor( TCustomPlot *parentPlot, QCPAbstractItem *parentItem, const QString &name, int anchorId=-1);
...
public:
  ...
  */
  ...
  QCPItemPosition( TCustomPlot *parentPlot, QCPAbstractItem *parentItem, const QString &name);
...
class  QCPAbstractItem : public QCPLayerable
{
  ...
  /// \endcond
public:
  explicit QCPAbstractItem( TCustomPlot *parentPlot);
...
class TCustomPlot : public CoWidgets
{
  Q_OBJECT
  /// \cond INCLUDE_QPROPERTIES
  ...
  /// \endcond
public:
    TCustomPlot(double StartX = 0, double StartY = 0, double StopX = 0, double StopY = 0,
  ...
  */
  ...
  /*!
    Defines with what timing the  TCustomPlot surface is refreshed after a replot.
  ...
  */
  ...
  Q_SLOT void replot( TCustomPlot::RefreshPriority refreshPriority= TCustomPlot::rpRefreshHint);
...
public slots:
    CoItem *Copy();
    void Copy(TCustomPlot *ChartFrom);
protected:
  // property members:
  QRect mViewport;
  QLocale mLocale;
...
Q_DECLARE_METATYPE( TCustomPlot::LayerInsertMode)
Q_DECLARE_METATYPE( TCustomPlot::RefreshPriority)
...
/*!
  ...
  lineData. NaN points create gaps in the line, as expected from  TCustomPlot's plottables (this is
  ...
  QPainter::drawPolyline if the configured \ref  TCustomPlot::setPlottingHints() and \a painter
  style allows.
*/
template <class DataType>
...
class  QCPAxisRect : public QCPLayoutElement
{
  ...
  /// \endcond
public:
  explicit QCPAxisRect( TCustomPlot *parentPlot, bool setupDefaultAxes=true);
  virtual ~QCPAxisRect();
...
class  QCPTextElement : public QCPLayoutElement
{
  ...
  /// \endcond
public:
  explicit QCPTextElement( TCustomPlot *parentPlot);
  QCPTextElement( TCustomPlot *parentPlot, const QString &text);
  QCPTextElement( TCustomPlot *parentPlot, const QString &text, double pointSize);
  QCPTextElement( TCustomPlot *parentPlot, const QString &text, const QString &fontFamily, double pointSize);
  QCPTextElement( TCustomPlot *parentPlot, const QString &text, const QFont &font);
...
class  QCPColorScale : public QCPLayoutElement
{
  ...
  /// \endcond
public:
  explicit QCPColorScale( TCustomPlot *parentPlot);
...
public:
  ...
  */
  ...
  QCPBarsGroup( TCustomPlot *parentPlot);
...
class  QCPItemStraightLine : public QCPAbstractItem
{
  ...
  /// \endcond
public:
  explicit QCPItemStraightLine( TCustomPlot *parentPlot);
...
class  QCPItemLine : public QCPAbstractItem
{
  ...
  /// \endcond
public:
  explicit QCPItemLine( TCustomPlot *parentPlot);
  virtual ~QCPItemLine();
...
class  QCPItemCurve : public QCPAbstractItem
{
  ...
  /// \endcond
public:
  explicit QCPItemCurve( TCustomPlot *parentPlot);
...
class  QCPItemRect : public QCPAbstractItem
{
  ...
  /// \endcond
public:
  explicit QCPItemRect( TCustomPlot *parentPlot);
  virtual ~QCPItemRect();
...
class  QCPItemText : public QCPAbstractItem
{
  ...
  /// \endcond
public:
  explicit QCPItemText( TCustomPlot *parentPlot);
  virtual ~QCPItemText();
...
class  QCPItemEllipse : public QCPAbstractItem
{
  ...
  /// \endcond
public:
  explicit QCPItemEllipse( TCustomPlot *parentPlot);
...
class  QCPItemPixmap : public QCPAbstractItem
{
  ...
  /// \endcond
public:
  explicit QCPItemPixmap( TCustomPlot *parentPlot);
...
public:
  ...
  */
  ...
  explicit QCPItemTracer( TCustomPlot *parentPlot);
...
public:
  ...
  */
  ...
  explicit QCPItemBracket( TCustomPlot *parentPlot);
